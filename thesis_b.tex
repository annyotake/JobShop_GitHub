...
\begin{equation}
  t^e_j = \sum_i{\sum_w{\sum^{\left\lceil\frac{pT_{ji}}{3\sigma}\right\rceil}_{d = \left\lceil\frac{sT_{ji}}{3\sigma}\right\rceil}{\left( wt^w_d - \sigma \right)}}}
\end{equation}
...
\centering
  ...
  \begin{tabular}{ll}  \hline
    ...
    $j$ & ジョブの番号　$j \in J = \{1,2,\cdots,N_j\}$であり，$N_j$はジョブの数を表す．\\ \hline
		...
		$R^{\tau}_{ji}$ & 作業$O_{ji}$の種類と資源 \\ \hline
